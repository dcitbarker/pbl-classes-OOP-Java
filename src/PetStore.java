...
public class PetStore {
    ...
    public PetStore(String storeName) {
        ...
        Member member1 = new Member("Joe", getNextMemberID(), true);
    ...
    public void loadAllPets() {
        ...
        Cat cat2 = new Cat("Clover", "American Short Hair", "Female", 6, 18, getNextPetID(), 150);
    ...
    public void removePet(String type, int index) {
        ...
        else if (type.equals("Exotic Pet"))
